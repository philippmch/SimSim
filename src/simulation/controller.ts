...
import type {NextActionResult} from './scheduler'
import type {WorkerCommand,WorkerEvent} from './protocol'
import type {Config,World} from './types'
export interface SimulationSnapshotMeta{stepId?:number;stepResult?:NextActionResult}
