...
The arena now leads the page with a live description based on living creatures' current actions and actual food counts. Click a creature for its action, purpose, and energy; survival forecasts and captured decision telemetry start collapsed. Completed generations summarize survival, births, population change, and death causes. Environment tools, event history, statistics, journals, lineages, and charts remain available in expandable sections; review links open their destination before moving focus.

In the ecological model, survivors retain their homes and offspring begin at the parent's chosen home. Founders and new migrants receive random starting homes. At a round boundary, a survivor may move up to 0.06 arena units along its existing edge, using only average locations of food it collected and attackers it encountered that round. Staying wins unless the estimated benefit exceeds the movement cost and at least a quarter of the starting energy reserve remains. Relocation is paid from energy remaining after survival and reproduction costs; it cannot rescue a creature that failed settlement. Per-round experience resets, while the last move's reason and cost remain visible in the inspector and recorded moves appear in event history. Classic mode retains its historical random placement. Old saves load without relocation experience, and begin collecting it from the restored moment.
